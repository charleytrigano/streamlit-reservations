...
def vue_clients(df, palette):
    ...
    if need.any(): clients.loc[need,"pays"] = clients.loc[need,"telephone"].apply(_phone_country)
...
def vue_id(df, palette):
    ...
    if need.any(): tbl.loc[need,"pays"] = tbl.loc[need,"telephone"].apply(_phone_country)
...
def main():
    ...
    if changed:
        ...
        # Pas de rerun immédiat : on continue, puis l’utilisateur peut naviguer
