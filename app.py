# app.py — Villa Tobias (COMPLET, palette + calendrier lisible sombre + ICS + SMS)
# - Palette plateformes éditable (ajouter/supprimer/changer couleur) en sidebar
# - Réservations : filtre "Payé / Non payé / Tous" corrigé, cases Payé & SMS éditables
# - Calendrier mensuel rendu en HTML (fond cell par plateforme, texte auto noir/blanc, lisible en thème sombre)
# - Rapport, Clients, Export ICS, SMS
# - Sauvegarde / Restauration XLSX
# - Remplacement intégral de st.experimental_rerun() -> st.rerun()
