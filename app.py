...
# Pastilles pour plateformes (affichage calendrier)
...
# ---------- CALENDRIER (VERSION STABLE : st.table + cellules texte) ----------
def vue_calendrier(df: pd.DataFrame):
    ...
    # Contenu par jour (emoji couleur + nom)
    ...
    # Grille semaine (L M M J V S D) — tout en chaînes
    ...
    # Liste des réservations du mois (optionnelle)
...
def main():
    ...
    if onglet == "📋 Réservations":
        ...
        vue_calendrier(df)  # ← version stable
    elif onglet == "📊 Rapport":
        vue_rapport(df)
