...
def kpi_chips(df):
    ...
    b = df["prix_brut"].sum()
    n = df["prix_net"].sum()
    html = f"""<style>...</style><div class="chips-container">...</div>""" # Le CSS et HTML des KPIs ici
...
def vue_calendrier(df, palette):
    ...
    if df_dates_valides.empty:
        ...
        return
    # ... (Code complet du calendrier)
    pass

def vue_rapport(df, palette):
    st.header("📊 Rapport")
    st.info("La page Rapport est en cours de restauration.")
