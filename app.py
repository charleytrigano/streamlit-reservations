...
b = int(bg_hex[4:6], 16)
# luminance "perçue"
luminance = (0.299r + 0.587g + 0.114*b) / 255
...
if name == "main":
main()
Lorsque je lance l appli j ai ce message       /mount/src/streamlit-reservations/app.py", line 420           “We are delighted to welcome you to Nice. \n\n”           ^ SyntaxError: invalid character '“' (U+201C).           Sans rien casser réparé ce fichier que tu gardera comme definitif
